...
Baseline: Training model on ImageNet
...
#    tf.keras.callbacks.EarlyStopping(monitor = 'val_loss', min_delta = 0, patience = 10, verbose = 1, mode = 'auto', baseline = None),
    ...
    # Tensorboard
    tf.keras.callbacks.TensorBoard(log_dir='./baseline_logs', histogram_freq=0, write_graph=True, write_grads=False, write_images=False)
    ]
